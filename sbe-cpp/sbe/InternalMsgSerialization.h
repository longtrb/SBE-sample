...
#ifndef _SBE_INTERNALMSGSERIALIZATION_H_
#define _SBE_INTERNALMSGSERIALIZATION_H_
...
class InternalMsgSerialization
{
private:
...
public:
    ...
    InternalMsgSerialization() = default;

    InternalMsgSerialization(
        char *buffer,
    ...
    InternalMsgSerialization(char *buffer, const std::uint64_t bufferLength) :
        InternalMsgSerialization(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    InternalMsgSerialization(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        InternalMsgSerialization(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    InternalMsgSerialization &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        return *this = InternalMsgSerialization(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    InternalMsgSerialization &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = InternalMsgSerialization(
            buffer,
    ...
    InternalMsgSerialization &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
        const std::uint64_t bufferLength)
    {
        return *this = InternalMsgSerialization(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }

    InternalMsgSerialization &sbeRewind()
    {
    ...
    {
        InternalMsgSerialization skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
#pragma clang diagnostic pop
    ...
    SBE_NODISCARD std::uint64_t id() const SBE_NOEXCEPT
    {
        std::uint64_t val;
    ...
    InternalMsgSerialization &id(const std::uint64_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    static SBE_CONSTEXPR std::uint8_t availableNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_UINT8;
    }

    static SBE_CONSTEXPR std::uint8_t availableMinValue() SBE_NOEXCEPT
    {
        return static_cast<std::uint8_t>(0);
    }

    static SBE_CONSTEXPR std::uint8_t availableMaxValue() SBE_NOEXCEPT
    {
    ...
    SBE_NODISCARD std::uint8_t available() const SBE_NOEXCEPT
    {
        std::uint8_t val;
    ...
    InternalMsgSerialization &available(const std::uint8_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    static SBE_CONSTEXPR std::uint32_t typeNullValue() SBE_NOEXCEPT
    {
        return SBE_NULLVALUE_UINT32;
    }

    static SBE_CONSTEXPR std::uint32_t typeMinValue() SBE_NOEXCEPT
    {
        return UINT32_C(0x0);
    }

    static SBE_CONSTEXPR std::uint32_t typeMaxValue() SBE_NOEXCEPT
    {
    ...
    SBE_NODISCARD std::uint32_t type() const SBE_NOEXCEPT
    {
        std::uint32_t val;
    ...
    InternalMsgSerialization &type(const std::uint32_t value) SBE_NOEXCEPT
    {
...
#pragma clang diagnostic pop
    ...
    SBE_NODISCARD double quantity() const SBE_NOEXCEPT
    {
        ...
        std::memcpy(&val, m_buffer + m_offset + 13, sizeof(double));
        val.uint_value = SBE_LITTLE_ENDIAN_ENCODE_64(val.uint_value);
        return val.fp_value;
    }

    InternalMsgSerialization &quantity(const double value) SBE_NOEXCEPT
    {
        union sbe_double_as_uint_u val;
        val.fp_value = value;
        val.uint_value = SBE_LITTLE_ENDIAN_ENCODE_64(val.uint_value);
        std::memcpy(m_buffer + m_offset + 13, &val, sizeof(double));
        return *this;
    }
...
#pragma clang diagnostic pop
    ...
    InternalMsgSerialization &price(const double value) SBE_NOEXCEPT
    {
        union sbe_double_as_uint_u val;
        val.fp_value = value;
        val.uint_value = SBE_LITTLE_ENDIAN_ENCODE_64(val.uint_value);
...
#pragma clang diagnostic pop
    ...
    InternalMsgSerialization &putSymbol(const char *src, const std::uint32_t length)
    {
        std::uint64_t lengthOfLengthField = 4;
        std::uint64_t lengthPosition = sbePosition();
    ...
    InternalMsgSerialization &putSymbol(const std::string &str)
    {
    ...
    #if __cplusplus >= 201703L
    InternalMsgSerialization &putSymbol(const std::string_view str)
    {
        if (str.length() > 1073741824)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    SBE_NODISCARD static const char *reqIdMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static const char *reqIdCharacterEncoding() SBE_NOEXCEPT
    {
        return "ASCII";
    }

    static SBE_CONSTEXPR std::uint64_t reqIdSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    bool reqIdInActingVersion() SBE_NOEXCEPT
    {
#if defined(__clang__)
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wtautological-compare"
#endif
        return m_actingVersion >= reqIdSinceVersion();
#if defined(__clang__)
#pragma clang diagnostic pop
#endif
    }

    static SBE_CONSTEXPR std::uint16_t reqIdId() SBE_NOEXCEPT
    {
        return 7;
    }

    static SBE_CONSTEXPR std::uint64_t reqIdHeaderLength() SBE_NOEXCEPT
    {
        return 4;
    }

    SBE_NODISCARD std::uint32_t reqIdLength() const
    {
        std::uint32_t length;
        std::memcpy(&length, m_buffer + sbePosition(), sizeof(std::uint32_t));
        return SBE_LITTLE_ENDIAN_ENCODE_32(length);
    ...
    SBE_NODISCARD const char *reqId()
    {
        std::uint32_t lengthFieldValue;
        std::memcpy(&lengthFieldValue, m_buffer + sbePosition(), sizeof(std::uint32_t));
        const char *fieldPtr = m_buffer + sbePosition() + 4;
    ...
    std::uint64_t getReqId(char *dst, const std::uint64_t length)
    {
        std::uint64_t lengthOfLengthField = 4;
        std::uint64_t lengthPosition = sbePosition();
        sbePosition(lengthPosition + lengthOfLengthField);
    ...
    InternalMsgSerialization &putReqId(const char *src, const std::uint32_t length)
    {
        std::uint64_t lengthOfLengthField = 4;
        std::uint64_t lengthPosition = sbePosition();
        std::uint32_t lengthFieldValue = SBE_LITTLE_ENDIAN_ENCODE_32(length);
    ...
    std::string getReqIdAsJsonEscapedString()
    {
        std::ostringstream oss;
        std::string s = getReqIdAsString();
    ...
    #if __cplusplus >= 201703L
    std::string_view getReqIdAsStringView()
    {
        std::uint64_t lengthOfLengthField = 4;
        std::uint64_t lengthPosition = sbePosition();
        sbePosition(lengthPosition + lengthOfLengthField);
    ...
    InternalMsgSerialization &putReqId(const std::string &str)
    {
        if (str.length() > 1073741824)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
        }
        return putReqId(str.data(), static_cast<std::uint32_t>(str.length()));
    }

    #if __cplusplus >= 201703L
    InternalMsgSerialization &putReqId(const std::string_view str)
    {
        if (str.length() > 1073741824)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    SBE_NODISCARD static const char *custIdMetaAttribute(const MetaAttribute metaAttribute) SBE_NOEXCEPT
    {
        switch (metaAttribute)
        {
            case MetaAttribute::PRESENCE: return "required";
    ...
    static const char *custIdCharacterEncoding() SBE_NOEXCEPT
    {
        return "ASCII";
    }

    static SBE_CONSTEXPR std::uint64_t custIdSinceVersion() SBE_NOEXCEPT
    {
        return 0;
    }

    bool custIdInActingVersion() SBE_NOEXCEPT
    {
#if defined(__clang__)
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wtautological-compare"
#endif
        return m_actingVersion >= custIdSinceVersion();
#if defined(__clang__)
#pragma clang diagnostic pop
#endif
    }

    static SBE_CONSTEXPR std::uint16_t custIdId() SBE_NOEXCEPT
    {
        return 8;
    }

    static SBE_CONSTEXPR std::uint64_t custIdHeaderLength() SBE_NOEXCEPT
    {
        return 4;
    }

    SBE_NODISCARD std::uint32_t custIdLength() const
    {
        std::uint32_t length;
        std::memcpy(&length, m_buffer + sbePosition(), sizeof(std::uint32_t));
        return SBE_LITTLE_ENDIAN_ENCODE_32(length);
    ...
    SBE_NODISCARD const char *custId()
    {
        std::uint32_t lengthFieldValue;
        std::memcpy(&lengthFieldValue, m_buffer + sbePosition(), sizeof(std::uint32_t));
        const char *fieldPtr = m_buffer + sbePosition() + 4;
    ...
    std::uint64_t getCustId(char *dst, const std::uint64_t length)
    {
        std::uint64_t lengthOfLengthField = 4;
        std::uint64_t lengthPosition = sbePosition();
        sbePosition(lengthPosition + lengthOfLengthField);
    ...
    InternalMsgSerialization &putCustId(const char *src, const std::uint32_t length)
    {
        std::uint64_t lengthOfLengthField = 4;
        std::uint64_t lengthPosition = sbePosition();
        std::uint32_t lengthFieldValue = SBE_LITTLE_ENDIAN_ENCODE_32(length);
    ...
    std::string getCustIdAsJsonEscapedString()
    {
        std::ostringstream oss;
        std::string s = getCustIdAsString();
    ...
    #if __cplusplus >= 201703L
    std::string_view getCustIdAsStringView()
    {
        std::uint64_t lengthOfLengthField = 4;
        std::uint64_t lengthPosition = sbePosition();
        sbePosition(lengthPosition + lengthOfLengthField);
    ...
    InternalMsgSerialization &putCustId(const std::string &str)
    {
        if (str.length() > 1073741824)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
        }
        return putCustId(str.data(), static_cast<std::uint32_t>(str.length()));
    }

    #if __cplusplus >= 201703L
    InternalMsgSerialization &putCustId(const std::string_view str)
    {
        if (str.length() > 1073741824)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, InternalMsgSerialization _writer)
{
    InternalMsgSerialization writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "InternalMsgSerialization", )";
    ...
    builder << R"("reqId": )";
    builder << '"' <<
        writer.getReqIdAsJsonEscapedString().c_str() << '"';

    builder << ", ";
    builder << R"("custId": )";
    builder << '"' <<
        writer.getCustIdAsJsonEscapedString().c_str() << '"';
...
SBE_NODISCARD static std::size_t computeLength(
    ...
    std::size_t reqIdLength = 0,
    std::size_t custIdLength = 0)
{
...
#pragma GCC diagnostic ignored "-Wtype-limits"
    ...
    length += reqIdHeaderLength();
    if (reqIdLength > 1073741824LL)
    {
        throw std::runtime_error("reqIdLength too long for length type [E109]");
    }
    length += reqIdLength;

    length += custIdHeaderLength();
    if (custIdLength > 1073741824LL)
    {
        throw std::runtime_error("custIdLength too long for length type [E109]");
    }
    length += custIdLength;
